...
func NssfPod(cr *fivegv1alpha1.Nssf) *corev1.Pod {
	container := nssfContainer(cr)
	init_container := nssfInitContainer(cr)

	return &corev1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			//Name: fmt.Sprintf("%s-%s", cr.Name, "nssf"),
			Name:      cr.Name,
...
func nssfInitContainer(cr *fivegv1alpha1.Nssf) *corev1.Container {
...
func nssfContainer(cr *fivegv1alpha1.Nssf) *corev1.Container {
	return &corev1.Container{
		Name:                     "nssf",
