...
func AusfPod(cr *fivegv1alpha1.Ausf) *corev1.Pod {
	container := ausfContainer(cr)
	init_container := ausfInitContainer(cr)

	return &corev1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			//Name: fmt.Sprintf("%s-%s", cr.Name, "ausf"),
			Name:      cr.Name,
...
func ausfInitContainer(cr *fivegv1alpha1.Ausf) *corev1.Container {
...
func ausfContainer(cr *fivegv1alpha1.Ausf) *corev1.Container {
	return &corev1.Container{
		Name:                     "ausf",
