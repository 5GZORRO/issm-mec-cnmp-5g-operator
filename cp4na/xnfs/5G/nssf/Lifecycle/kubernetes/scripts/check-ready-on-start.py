def checkReady(keg, props, resultBuilder, log, *args, **kwargs):    
    found, start = keg.objects.get('5g.ibm.com/v1alpha1', 'Transition', props['system_properties']['resource_subdomain'] + "-start", namespace=props['deployment_location']['properties']['defaultObjectNamespace'])
    if not found:
